...
# FIXME: this test is not working beacuse issn has been fixed to 8 chars & when the issn is 0032-5910, it fails
# TODO: discuss if the issn length contraint is needed
